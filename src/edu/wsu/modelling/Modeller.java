...
public class Modeller implements Observer, TurnListener {
	...
	public synchronized void drawSurroundings(SensorHandler sensorHandler) {
		...
		for (ObservableSensor sensor : distanceSensors.keySet()) {
			IndexPair positionToDraw = envModel.findPositionFromSensorEnum(currentPosition, sensor.getSensor());
